...
$(document).ready(function() {
    ...
    let options = {
        center: {lat: 33.4478, lng: -112.0641}, // Phoenix, AZ
...
function addMarker(place)
{
    ...
    // Make custom marker so I can relocate the label below marker
    // Thank goodness for stack exchange users helping me realize I can only use labelOrigin with a custom marker
        //https://cs50.stackexchange.com/questions/28094/mashup-how-to-add-label-outside-the-icons
    var image = {
